...
func (m *MockEarlyConnection) AddPath(arg0 net.Addr, arg1 quic.PathID) error {
	m.ctrl.T.Helper()
...
func (mr *MockEarlyConnectionMockRecorder) AddPath(arg0, arg1 any) *MockEarlyConnectionAddPathCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AddPath", reflect.TypeOf((*MockEarlyConnection)(nil).AddPath), arg0, arg1)
...
// Return rewrite *gomock.Call.Return
func (c *MockEarlyConnectionAddPathCall) Return(arg0 error) *MockEarlyConnectionAddPathCall {
	c.Call = c.Call.Return(arg0)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockEarlyConnectionAddPathCall) Do(f func(net.Addr, quic.PathID) error) *MockEarlyConnectionAddPathCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockEarlyConnectionAddPathCall) DoAndReturn(f func(net.Addr, quic.PathID) error) *MockEarlyConnectionAddPathCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}

// UpdatePathRSSI mocks base method.
func (m *MockEarlyConnection) UpdatePathRSSI(arg0 quic.PathID, arg1 int) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdatePathRSSI", arg0, arg1)
	ret0, _ := ret[0].(error)
	return ret0
}

// UpdatePathRSSI indicates an expected call of UpdatePathRSSI.
func (mr *MockEarlyConnectionMockRecorder) UpdatePathRSSI(arg0, arg1 any) *MockEarlyConnectionUpdatePathRSISCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdatePathRSSI", reflect.TypeOf((*MockEarlyConnection)(nil).UpdatePathRSSI), arg0, arg1)
	return &MockEarlyConnectionUpdatePathRSISCall{Call: call}
}

// MockEarlyConnectionUpdatePathRSISCall wrap *gomock.Call
type MockEarlyConnectionUpdatePathRSISCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockEarlyConnectionUpdatePathRSISCall) Return(arg0 error) *MockEarlyConnectionUpdatePathRSISCall {
	c.Call = c.Call.Return(arg0)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockEarlyConnectionUpdatePathRSISCall) Do(f func(quic.PathID, int) error) *MockEarlyConnectionUpdatePathRSISCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockEarlyConnectionUpdatePathRSISCall) DoAndReturn(f func(quic.PathID, int) error) *MockEarlyConnectionUpdatePathRSISCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
