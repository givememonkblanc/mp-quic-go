...
func (m *MockQUICConn) AddPath(arg0 net.Addr, arg1 PathID) error {
	m.ctrl.T.Helper()
...
func (mr *MockQUICConnMockRecorder) AddPath(arg0, arg1 any) *MockQUICConnAddPathCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AddPath", reflect.TypeOf((*MockQUICConn)(nil).AddPath), arg0, arg1)
...
// Return rewrite *gomock.Call.Return
func (c *MockQUICConnAddPathCall) Return(arg0 error) *MockQUICConnAddPathCall {
	c.Call = c.Call.Return(arg0)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockQUICConnAddPathCall) Do(f func(net.Addr, PathID) error) *MockQUICConnAddPathCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockQUICConnAddPathCall) DoAndReturn(f func(net.Addr, PathID) error) *MockQUICConnAddPathCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
...
func (mr *MockQUICConnMockRecorder) UpdatePathRSSI(arg0, arg1 any) *MockQUICConnUpdatePathRSISCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdatePathRSSI", reflect.TypeOf((*MockQUICConn)(nil).UpdatePathRSSI), arg0, arg1)
	return &MockQUICConnUpdatePathRSISCall{Call: call}
}

// MockQUICConnUpdatePathRSISCall wrap *gomock.Call
type MockQUICConnUpdatePathRSISCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockQUICConnUpdatePathRSISCall) Return(arg0 error) *MockQUICConnUpdatePathRSISCall {
	c.Call = c.Call.Return(arg0)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockQUICConnUpdatePathRSISCall) Do(f func(PathID, int) error) *MockQUICConnUpdatePathRSISCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockQUICConnUpdatePathRSISCall) DoAndReturn(f func(PathID, int) error) *MockQUICConnUpdatePathRSISCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
