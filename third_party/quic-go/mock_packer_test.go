...
func (m *MockPacker) SetPacketNumberManager(arg0 packetNumberManager) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "SetPacketNumberManager", arg0)
}

// SetPacketNumberManager indicates an expected call of SetPacketNumberManager.
func (mr *MockPackerMockRecorder) SetPacketNumberManager(arg0 any) *MockPackerSetPacketNumberManagerCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetPacketNumberManager", reflect.TypeOf((*MockPacker)(nil).SetPacketNumberManager), arg0)
	return &MockPackerSetPacketNumberManagerCall{Call: call}
}

// MockPackerSetPacketNumberManagerCall wrap *gomock.Call
type MockPackerSetPacketNumberManagerCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockPackerSetPacketNumberManagerCall) Return() *MockPackerSetPacketNumberManagerCall {
	c.Call = c.Call.Return()
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockPackerSetPacketNumberManagerCall) Do(f func(packetNumberManager)) *MockPackerSetPacketNumberManagerCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockPackerSetPacketNumberManagerCall) DoAndReturn(f func(packetNumberManager)) *MockPackerSetPacketNumberManagerCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
